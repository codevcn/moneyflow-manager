...
Tôi sẽ mô tả app flow để bạn hiểu rõ hơn về cách hoạt động của ứng dụng Money Flow Manager.
...
- Bảng màu chủ đạo:
  - Màu chính: Xanh dương đen (#1E88E5)
  - Màu phụ: Xanh lá cây (#43A047)
  - Màu nền sáng: Trắng (#FFFFFF)
  - Màu nền tối: Xám đậm (#121212)
  - Màu chữ chính: Đen (#000000) cho chế độ sáng, Trắng (#FFFFFF) cho chế độ tối
  - Màu chữ phụ: Xám (#757575)
...
- Thời gian tải dữ liệu nhanh, không quá 2 giây khi mở ứng dụng hoặc chuyển đổi giữa các tab.
